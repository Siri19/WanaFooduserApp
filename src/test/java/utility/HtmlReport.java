...
public class HtmlReport extends ReadData{
	...
	public void generateHtmlReport(String paramString1) throws IOException
	{
		 ...
		 * writer.write("<font face= \"calibri\" size = \"4\">" + testCaseName1.size()
		 * +" </font>"); writer.write(" </td>");
		 */
	...
	public void generate(String paramString1) throws IOException
	{
		try{
			...
			writer.write("<p>");
				int y=0,j,x;
				System.out.println(testFullName.size());
				for (int k = 0; k < testFullName.size(); k++) 
				{
					x=0;
						...
						if (classes.get(j).equals(testFullName.get(k)))
						{
							...
							writer.write(" </td>");
								...
								if(errorDes.size() > j) {
									...
									writer.write("<font face= \"calibri\" size = \"4\"> </font>");
								}
	...
	/*
	 * public static void main(String arg[]) throws Exception { HtmlReport
	 * report=new HtmlReport(); report.
	 * generateHtmlReport("C:\\Selenium Training\\pattabhi_adminconsole_mobile_framework\\test.html"
	 * ); }
	 */
}
